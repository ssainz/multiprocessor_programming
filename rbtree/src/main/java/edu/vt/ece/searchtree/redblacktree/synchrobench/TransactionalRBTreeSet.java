...
/**
 * Red-Black tree benchmark. Adapted from {@link
 * ://www.codeproject.com/csharp/RedBlackCS.asp}
 *
 * @author Maurice Herlihy
 */
public class TransactionalRBTreeSet<K extends Comparable<K>, V> implements CompositionalIntSet,
        CompositionalMap<K, V>, SearchTree<K, V> {
